...
const translations = {
  ar: {
    ...
    navStocktake: 'الجرد ومطابقة المخزون',
    ...
    reason: 'سبب التعديل',
    stocktakeTitle: 'الجرد المخزني ومطابقة الأرصدة',
    newStocktake: 'جلسة جرد جديدة',
    startStocktake: 'بدء عملية الجرد',
    stocktakeHistory: 'سجل جلسات الجرد',
    expectedStock: 'رصيد النظام (المتوقع)',
    countedStock: 'الرصيد الفعلي (الممسوح)',
    discrepancy: 'الفارق / المخالفة',
    varianceCost: 'أثر التكلفة',
    reconcileStock: 'اعتماد وتطبيق الجرد على المخزون',
    reconcileWarning: 'سيتم تحديث أرصدة المخزون الفعلي في قاعدة البيانات لتطابق تماماً الكميات الممسوحة بالجرد.',
    matchedItems: 'مطابق تماماً',
    deficitItems: 'عجز / نقص',
    surplusItems: 'زيادة / فائض',
    uncountedItems: 'قطع لم تُمسح',
    quickScanMode: 'وضع المسح السريع بالسكانر',
    lastScannedItem: 'آخر قطعة تم مسحها',

    // Sales & POS
    posTitle: 'شاشة المبيعات ونقاط البيع (POS)',
    newSale: 'فاتورة بيع جديدة',
    searchProductOrBarcode: 'ابحث باسم الموديل أو امسح الباركود...',
    scanGunPrompt: 'امسح الباركود بالماسح الضوئي (أو اكتب واضغط Enter)... [F2]',
    cart: 'سلة المشتريات',
    customer: 'العميل',
  ...
  en: {
    ...
    totalSales: 'Gross Sales',
    totalProfit: 'Gross Profit',
    totalExpenses: 'Total Expenses',
    netIncome: 'Net Income',
    inventoryValue: 'Inventory Asset Value',
    lowStockAlert: 'Low Stock Alerts',
    transactionsCount: 'Total Invoices',
    salesTrend: 'Sales Velocity',
    topSellingProducts: 'Top Velocity Products',
    topClients: 'Top VIP Clients',
    ...
    stocktakeTitle: 'Physical Inventory Stocktake',
    newStocktake: 'New Stocktake Session',
    startStocktake: 'Start Count',
    stocktakeHistory: 'Stocktake History',
    expectedStock: 'System Expected Stock',
    countedStock: 'Physical Scanned Count',
    discrepancy: 'Variance / Discrepancy',
    varianceCost: 'Variance Cost Impact',
    reconcileStock: 'Reconcile & Update Inventory',
    reconcileWarning: 'This will atomically update all current stock records to match physical scanned counts.',
    matchedItems: 'Matched (Exact)',
    deficitItems: 'Deficit / Shortage',
    surplusItems: 'Surplus',
    uncountedItems: 'Uncounted',
    quickScanMode: 'Rapid Barcode Gun Mode',
    ...
    scanGunPrompt: 'Scan barcode with scanner gun (or type & hit Enter)... [F2]',
    cart: 'Order Cart',
    customer: 'Customer',
